...
const Reviews = () => {
    ...
    return (
        <main> 
            ...
            <p>Welcome to our movie review page! Here, we bring you the latest reviews of the hottest releases in theaters and streaming platforms. Our team of experienced movie critics watches every film with a discerning eye and provides honest and objective critiques of each one.</p>
