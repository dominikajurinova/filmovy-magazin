    ...
    return (
        <main> 
            <div className="articles">
                <h1>Articles</h1>
                <p>Welcome to our page dedicated to all things film! Here you will find a collection of articles covering a wide range of topics related to the world of cinema. From in-depth analyses of the latest releases to explorations of film history, we offer a variety of perspectives on the art of filmmaking.</p>
